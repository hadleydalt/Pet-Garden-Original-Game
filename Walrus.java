...
// creates a Walrus. Its methods are explained in the Pet superclass.
...
public class Walrus extends Pet{
    ...
    public void addToPane(){
        _root.getChildren().addAll(this.getBody(), _tusk1, _tusk2, _eye1, _eye2, _pupil1, _pupil2, _mouth, _nose, _nosedivide, _spot1, _spot2, _spot3,
                _spot4, _spot5, _spot6, _flipper1, _flipper2, _tail1, _tail2, _coverNode);
    }
